...
function App() {
  ...
  //   dispatch(actions.addOne(e.target.value))
  // }
  ...
  const handleUseMemory = () => {
      dispatch(actions.useMemory())
  }

  const handleAddToMemory = () => {
    dispatch(actions.addToMemory())
  }
        ...
        <div className="col-md-12 d-flex justify-content-center">
          <form name="Cal">
            ...
            <div className="row details">
              ...
              <span id="memory"><b>{state.memory}</b>{state.total}</span>
            </div>
            
            <div className="row">
              <CalcButton onClick={handleUseMemory}value={"M+"} />
